# CLAUDE.md — HoneyDrunk.Lore

This file is the schema and operating manual for the Lore wiki. Any Claude Code session pointed at this repo follows the rules below.
