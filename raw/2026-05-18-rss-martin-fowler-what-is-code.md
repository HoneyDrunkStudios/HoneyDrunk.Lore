...
date_published: "2026-05-12T09:30:00-04:00"
...
This is why the idea of a bounded context in 
...
of a ubiquitous language : a shared language developed by developers and domain experts and tested continuously against working software.
Programming Languages As Thinking Tools 
...
implementation.
Cognitive Debt 
This also explains a particular danger of LLM-assisted coding: cognitive debt. 
...
to cognitive debt.
Code as a shared Conceptual Model 
As we discussed in Designing Abstractions with LLMs , 
writing code has 
...
Acknowledgments 
I would like to thank Rebecca Parsons and Martin Fowler 
for their valuable feedback on the early drafts of the article.
Margaret Story, Max Kanat-Alexander, Premanand Chandrasekaran, Nate Schutta, Kavi Sekhon, 
Misma Silfver, Ricardo Piccoli, and Vinod Kumaar R 
commented on the draft and gave suggestions.
Gemini and ChatGPT were used to help refine the language of the existing write-up 
and assist with copy-editing the article.
Significant Revisions 
12 May 2026: published
