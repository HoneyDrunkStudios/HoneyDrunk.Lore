---
source: "https://learn.microsoft.com/en-us/azure/architecture/ai-ml/idea/multiple-agent-workflow-automation"
title: "Build a Multiple-Agent Workflow Automation Solution by using Microsoft Agent Framework - Azure Architecture Center"
author: "malrose07"
...
Add to plan
[Edit](https://github.com/microsoftdocs/architecture-center/blob/main/docs/ai-ml/idea/multiple-agent-workflow-automation.yml)
...
2. The Azure App Service website receives the user request from the front end and calls an API hosted in Container Apps. The API processes the incoming task and determines which specialized AI agents to use. The API separates the task into component parts for multiple-agent coordination.
3. The Container Apps API connects to a Microsoft Foundry-hosted GPT-4.1 model. The API orchestrates multiple specialized AI agents to handle different aspects of the task. Agents collaborate to plan, perform, and validate the required tasks.
4. Azure Cosmos DB stores all data related to current and past plans and solutions. It maintains historical task data and patterns for learning and optimization purposes. It also persists agent decisions and outcomes for future reference.
...
Sequential patterns suit dependent tasks like document approval workflows. Concurrent patterns suit independent operations like data collection from multiple sources. Group chat patterns enable collaborative problem-solving. Handoff patterns let specialized agents handle different workflow phases. For more information about how to implement these coordination strategies, see [AI agent orchestration patterns](/en-us/azure/architecture/ai-ml/guide/ai-agent-design-patterns). This article provides architectural patterns and implementation considerations for various multiple-agent scenarios.
...
For more information about the costs of running this scenario, see this [Azure pricing estimate](https://azure.com/e/a96b2497ec854b89a99362bde8d20e84).
...
- [Overview of the Agent Framework workflows](/en-us/agent-framework/workflows/)
- [Foundry Agent Service documentation](/en-us/azure/foundry/agents/overview)
