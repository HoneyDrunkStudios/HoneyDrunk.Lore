---
source: "https://opentelemetry.io/blog/2026/introducing-the-ecosystem-explorer/"
title: "Introducing the Ecosystem Explorer Project"
author: "OpenTelemetry Blog"
date_published: "Thu, 30 Apr 2026 05:23:27 -0400"
...
Blog 2026 Ecosystem Explorer Project Introducing the Ecosystem Explorer Project By Jay DeLuca (Grafana Labs) |
Thursday, April 30, 2026 OpenTelemetry is vast. The Java agent alone includes over 240 different
...
In our
2025 Developer Experience Survey ,
...
of users rely on opentelemetry.io as their primary
...
OpenTelemetry 2025 Year in Review post ,
the existing OpenTelemetry Registry helps users discover
...
explorer.opentelemetry.io - but it is
very much still a work in progress.
The Java agent ecosystem The Java agent is our first fully mapped ecosystem. Over 240 instrumentations
are
...
new ecosystems.
The frontier: Explorers needed The Java agent is just one corner of the OpenTelemetry ecosystem. There’s a vast
landscape of other components waiting to be mapped, and each language presents
its own interesting challenges.
Expanding Java coverage Even within Java, we’re just getting started. The Java Agent’s built-in
...
Luca Cavenaghi (@lucacavenaghi97) who has
been doing amazing work on this new feature that is coming soon.
Here is a sneak peak:
Collector components The OpenTelemetry Collector has its own rich ecosystem of receivers, processors,
...
Python instrumentation The Python ecosystem works differently than Java. Instead of a single unified
...
JavaScript instrumentation JavaScript follows a similar pattern to Python, with OpenTelemetry JS
...
GenAI and LLM instrumentation This is some of the fastest moving, but still uncharted territory. OpenTelemetry
...
contributors could help answer .
Defining the language Beyond mapping specific ecosystems, there’s foundational work in defining how we
...
entirely.
Many ways to contribute You don’t need to be an OpenTelemetry expert to help. The project needs
different skills, and there are entry points at various levels.
Product designers and UX experts The information associated with these components can go deep and be very dense.
...
(and agents).
Research and documentation Before we can build automation for a new ecosystem, someone needs to understand
...
Python automation The data extraction pipelines are written in Python. Adding a new ecosystem
...
Web development The explorer frontend is React with TypeScript and Tailwind CSS. There’s plenty
...
Join the expedition Some contributors will go deep in one area, while others might help across
...
Pratik Jadhav (@pratik50) Luca Cavenaghi (@lucacavenaghi97) Adam Silva @adaumsilva Manohar Mallipudi (@Vjc5h3nt) Erick Ruiz de Chavez (@eruizdechavez) Love Kumar Chauhan (@LoveChauhan-18) Pittu Sharma (@Pittu-Sharma) The Ecosystem Explorer is live, the foundation is working, and there’s
interesting work ahead. If any of these sound appealing, here’s how to get
involved:
Explore the (work in progress) site :
explorer.opentelemetry.io Browse the code :
github.com/open-telemetry/opentelemetry-ecosystem-explorer Find (or submit) issues : Look for
“ good first issue ”
or
“ help wanted ”
labels. There are quite a few! Join the conversation :
#otel-ecosystem-explorer 
on CNCF Slack Attend meetings : Communications SIG, Tuesdays 9:00 AM PT (bi-weekly) Come help us map the ecosystem!
← Previous Next → Last modified April 30, 2026: Blog post for Ecosystem Explorer (#9690) (8a446fef)
