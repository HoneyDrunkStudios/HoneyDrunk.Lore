...
Slack Code is live today for teams using Claude (Anthropic), Devin (Cognition), GitHub (Copilot), and Vercel integrations, with OpenAI (ChatGPT) available soon. Mention the agent in a project channel to see it spin one up. Explore the announcement.
Product Update AI Agents & Automation Was this post useful? Yes, thanks! Not really 0 /600 Submit Feedback Awesome! Thanks so much for your feedback!
