...
title: "codebase-memory-mcp (GitHub Repo)"
author: "TLDR DevOps"
date_published: "Fri, 19 Jun 2026 00:00:00 GMT"
date_clipped: "2026-06-23"
category: "DevOps & CI/CD"
source_type: "rss"
discovered_via: "https://tldr.tech/devops/2026-06-19"
...
Linux kernel fast index 
1m 12s 
1.88M nodes 
Django full index 
~6s 
49K nodes, 196K edges 
Cypher query 
<1ms 
Relationship traversal 
Name search (regex) 
<10ms 
SQL LIKE pre-filtering 
Dead code detection 
~150ms 
Full graph scan with degree filtering 
Trace call path (depth=5) 
<10ms 
BFS traversal 
...
— 
Antigravity 
.gemini/config/mcp_config.json (shared) 
...
Queries return wrong project results 
Add project="name" parameter. Use list_projects to see names. 
Binary not found after install 
Add to PATH: export PATH="$HOME/.local/bin:$PATH" 
UI not loading 
Ensure you downloaded the ui variant and ran --ui=true . Check http://localhost:9749 . 
Hybrid LSP 
...
Tree-sitter pass — fast, syntactic, runs for every one of the 158 languages. Extracts definitions, calls, imports. 
