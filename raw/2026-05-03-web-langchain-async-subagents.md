...
author: "Hunter Lovell; Colin Francis"
...
- **Not all information about a small task is important for the large objective** - by splitting things out into focused, independent agent runs, we hide away unnecessary context from the supervisor.This pattern works. But as we’ve given agents longer and more complex tasks, inline subagents have started to break down.
