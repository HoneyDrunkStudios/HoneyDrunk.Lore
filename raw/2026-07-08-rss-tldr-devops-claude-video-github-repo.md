...
title: "Claude-video (GitHub Repo)"
author: "TLDR DevOps"
date_published: "2026-07-08"
date_clipped: "2026-07-08"
category: "DevOps & CI/CD"
source_type: "rss"
discovered_via: "https://tldr.tech/devops/2026-07-08"
...
≤30 s 
~30 frames 
Dense — basically every key moment 
30 s - 1 min 
~40 frames 
Still dense 
1 - 3 min 
...
Sparse but workable 
> 10 min 
100 frames (capped modes) 
"Sparse scan" warning — re-run focused, or --detail token-burner for full uncapped coverage 
...
0 
— 
~4.5 s (one yt-dlp call, no download) 
full (text) 
0 (≈26.6k text tokens) 
efficient 
...
What you need 
Cost 
Download + native captions 
yt-dlp + ffmpeg 
Free 
Whisper fallback (preferred) 
Groq API key — whisper-large-v3 
Cheap, fast 
Whisper fallback (alt) 
OpenAI API key — whisper-1 
Standard pricing 
Disable Whisper entirely 
--no-whisper 
