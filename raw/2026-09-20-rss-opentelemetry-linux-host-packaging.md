---
source: "https://opentelemetry.io/blog/2026/packaging-first-repo"
title: "One-command OpenTelemetry setup on Linux hosts"
author: "Antoine Toulme (Splunk); Michele Mancioppi (Dash0)"
...
Source: [One-command OpenTelemetry setup on Linux hosts](https://opentelemetry.io/blog/2026/packaging-first-repo)

Full written article reproduced under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). Attribution: Antoine Toulme (Splunk); Michele Mancioppi (Dash0); OpenTelemetry Authors. Formatting adapted from the publisher's Markdown version; relative links expanded. Publication-era caveats remain part of the source.
...
[OTel Unplugged EU](https://opentelemetry.io/blog/2025/otel-unplugged-fosdem/) in Brussels this
...
[Stable By Default vision](https://opentelemetry.io/blog/2025/stability-proposal-announcement/) of the
project.
