---
source: "https://www.lmsys.org/blog/2026-08-19-deepseek-v4-pro-engine-optimization-h20"
title: "Pushing the Limits of Serving DeepSeek-V4-Pro (28 minute read)"
author: "unknown"
...
1. Introduction 2. From Hardware Constraints to Serving Profiles 2.1 Hardware Constraints and Serving Roles 2.2 Capacity Choices Reducing Weight Footprint with Humming MXFP4AFP8 Expanding KV Capacity with Online C128 Combined Capacity Gains 2.3 Scenario-Specific Serving Profiles Prefill Profiles Low-Latency Decode Profiles High-Throughput Decode Profiles 3. Prefill: Balancing Compute and Communication 3.1 Why MoE-TP Instead of MoE-EP 3.2 Accelerating and Fusing Prefill Collectives 3.3 Tuning Humming for Real Routing Shapes 4. Decode: Optimizing Speculation and MoE Execution 4.1 Low-Latency PP2-TP8: Extending DSpark Across Pipeline Stages 4.2 High-Throughput DP32-EP32: Removing High-Concurrency Bottlenecks 4.3 Humming Decode Hot Path: Fusion and Overlap 5. Evaluation: System Gains and Profile Trade-offs 5.1 Prefill: Cumulative Gains and Context-Length Trade-offs 5.2 Low-Latency Decode: Performance and Capacity Trade-offs 5.3 High-Throughput Decode: Frontier Gains and Profile Trade-offs 6. Conclusion Acknowledgements Appendix A. Prefill Results A.1 Humming PP2 Prefill: Baseline vs. Final Profile A.2 Humming PP4 Prefill: Baseline vs. Final Profile Appendix B. Low-Latency Decode Results B.1 Peak TPOT Across Input Lengths and Batch Sizes B.1.1 No-Spec PP2-TP8 B.1.2 Optimized DSpark PP2-TP8 B.2 Batch-Size-1 Output Throughput B.3 Benchmark Settings Appendix C. High-Throughput Decode Results C.1 DP32-EP32 with FP8 + MTP (3, 1, 4) C.2 DP32-EP32 with FP8 + Optimized MTP (3, 1, 4) C.3 DP32-EP32 with FP8 + DSpark C.4 DP32-EP32 with Humming MXFP4AFP8 + Online C128 + DSpark C.5 DP16-EP16 with Humming MXFP4AFP8 + Online C128 + DSpark Appendix D. Capacity Results D.1 Decode Capacity Scaling D.2 Humming Accuracy Validation Pushing the Limits of Serving DeepSeek-V4-Pro Tianyu Zhang, Yusong Gao, Yun Zhang August 19, 2026 1. Introduction
...
Input Length Baseline TTFT (ms) Baseline Total Input Throughput (tokens/s) Final TTFT (ms) Final Total Input Throughput (tokens/s) 4K 775.8 5,280 573.3 7,140 8K 1202.1 6,810 907.6 9,030 16K 2059.8 7,950 1649.5 9,930 32K 4137.5 7,920 2470.3 13,260 64K 6195.7 10,580 4063.8 16,130 128K 10744.4 12,200 7975.9 16,430 256K 20542.2 12,760 15507.2 16,900 512K 44544.6 11,770 34982.6 14,990 1M 100304.2 10,450 79214.2 13,240
A.2 Humming PP4 Prefill: Baseline vs. Final Profile
Input Length Baseline TTFT (ms) Baseline Total Input Throughput (tokens/s) Final TTFT (ms) Final Total Input Throughput (tokens/s) 4K 924.6 4,430 687.9 5,950 8K 1174.5 6,970 890.3 9,200 16K 2202.0 7,440 1635.4 10,020 32K 4185.6 7,830 3068.4 10,680 64K 5252.4 12,480 3982.6 16,460 128K 7793.4 16,820 5882.5 22,280 256K 13210.7 19,840 10348.9 25,330 512K 26350.1 19,900 20273.1 25,860 1M 55532.3 18,880 43742.5 23,970
Appendix B. Low-Latency Decode Results
B.1 Peak TPOT Across Input Lengths and Batch Sizes
B.1.1 No-Spec PP2-TP8
Input Length / Batch Size (Peak TPOT, ms) 1 2 4 8 16 8K 26.39 30.86 31.31 31.79 31.74 32K 25.72 26.58 27.81 31.06 37.97 64K 25.75 26.62 28.13 29.19 38.75 128K 25.94 26.94 28.38 29.75 38.51 256K 26.08 27.21 28.84 32.43 38.83 512K 26.25 27.51 29.16 33.70 - 1M 26.42 27.81 29.52 - -
B.1.2 Optimized DSpark PP2-TP8
Input Length / Batch Size (Peak TPOT, ms) 1 2 4 8 16 32 4K 5.91 6.76 7.97 10.00 14.55 19.23 8K 5.80 6.87 8.85 10.48 15.18 19.60 32K 6.14 7.04 8.39 10.83 14.86 20.46 64K 6.15 7.13 8.73 10.39 15.49 21.65 128K 6.77 7.02 8.91 11.59 16.17 24.78 256K 5.76 6.98 8.61 11.98 17.72 - 512K 6.35 7.95 9.87 14.30 - - 1M 6.65 8.92 12.43 - - -
B.2 Batch-Size-1 Output Throughput
Input Length No-Spec PP2-TP8 (tokens/s) Optimized DSpark PP2-TP8 (tokens/s) Single-Node TP8 (tokens/s) 4K - 169 213 8K 38 172 260 16K - - 244 32K 39 163 269 64K 39 163 246 128K 39 148 267 256K 38 174 271 512K 38 157 254 1M 38 150 183
...
Input Length / Concurrent Requests per DP Rank (tokens/s/GPU) 1 2 4 8 16 32 4K 30.49 58.58 102.89 174.75 253.15 319.92 8K 30.34 58.29 102.38 174.67 251.62 318.32 16K 29.70 56.55 99.47 170.01 242.22 302.43 32K 29.58 56.35 98.28 164.26 234.13 - 64K 29.07 55.73 96.43 161.60 - - 128K 28.39 54.06 92.89 153.55 - - 256K 28.35 53.02 90.89 - - - 512K 27.51 51.49 - - - - 1M 27.05 - - - - -
C.2 DP32-EP32 with FP8 + Optimized MTP (3, 1, 4)
Input Length / Concurrent Requests per DP Rank (tokens/s/GPU) 1 2 4 8 16 32 4K 36.84 69.86 131.96 232.94 389.94 514.77 8K 32.58 69.51 131.53 222.06 348.80 416.82 16K 31.89 67.44 127.79 216.14 341.85 395.99 32K 31.49 67.21 124.49 208.83 337.97 - 64K 30.95 66.47 123.68 205.44 - - 128K 30.22 64.47 119.14 - - - 256K 30.18 63.23 - - - - 512K 29.28 61.40 - - - - 1M 28.79 - - - - -
C.3 DP32-EP32 with FP8 + DSpark
Input Length / Concurrent Requests per DP Rank (tokens/s/GPU) 1 2 4 8 16 32 4K 53.1 94.8 181.2 338.1 495.8 591.8 8K 44.5 88.4 170.1 317.3 495.5 - 16K 43.6 88.3 165.3 308.8 455.5 - 32K 43.0 87.3 161.0 298.4 - - 64K 42.3 86.3 158.0 - - - 128K 41.3 83.8 - - - - 256K 41.2 - - - - - 512K 40.0 - - - - - 1M 39.3 - - - - -
C.4 DP32-EP32 with Humming MXFP4AFP8 + Online C128 + DSpark
Input Length / Concurrent Requests per DP Rank (tokens/s/GPU) 1 2 4 8 16 32 4K 75.32 127.10 235.85 417.53 564.08 703.15 8K 75.60 128.29 238.01 417.34 560.68 709.64 16K 74.00 124.47 231.25 406.21 539.72 674.19 32K 73.07 122.27 225.28 392.47 521.70 601.67 64K 71.81 120.92 221.05 386.11 516.54 599.63 128K 70.12 117.29 212.93 366.88 487.69 - 256K 70.03 115.03 208.35 345.21 457.62 - 512K 67.95 111.71 191.99 302.80 - - 1M 66.82 105.82 177.48 - - -
C.5 DP16-EP16 with Humming MXFP4AFP8 + Online C128 + DSpark
Input Length / Concurrent Requests per DP Rank (tokens/s/GPU) 1 2 4 8 16 32 4K 76.80 129.62 236.83 397.42 584.37 759.73 8K 76.69 130.55 237.53 398.60 582.03 762.09 16K 76.16 127.88 233.10 388.54 571.22 745.23 32K 74.07 124.77 226.24 378.79 559.05 722.51 64K 74.57 124.69 223.84 373.13 541.46 695.35 128K 72.36 120.34 219.66 365.13 518.98 - 256K 71.38 119.19 211.64 340.72 - - 512K 69.54 115.14 198.81 - - - 1M 67.39 106.50 - - - -
Appendix D. Capacity Results
D.1 Decode Capacity Scaling
Decode Profile Configuration Full-Token Capacity (tokens/rank) Vs. Previous Stage Vs. FP8 Baseline DP32-EP32 Baseline FP8 + Offline C128 1,475,328 - 1.00× Humming MXFP4AFP8 + Offline C128 2,526,720 1.71× 1.71× Humming MXFP4AFP8 + Online C128 5,731,328 2.268× 3.88× PP2-TP8 Baseline FP8 + Offline C128 1,089,024 - 1.00× Humming MXFP4AFP8 + Offline C128 4,869,888 4.47× 4.47× Humming MXFP4AFP8 + Online C128 11,044,906 2.268× 10.14×
...
Backend GSM8K Accuracy Marlin MXFP4A16 96.5%–97.0% FlashInfer MXFP4 96.5%–97.0% Humming MXFP4A16 96.5%–97.5% Humming MXFP4AFP8 97.0%
