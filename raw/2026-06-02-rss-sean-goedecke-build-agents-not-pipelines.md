---
source: "https://www.seangoedecke.com/build-agents-not-pipelines/"
...
Build agents, not pipelines There are only two ways to use LLMs in a computer program: as part of a pipeline, or as an agent. In other words, either you express the control flow of the program in code, or you give a LLM tools and allow it to manage the control flow itself 1 .
