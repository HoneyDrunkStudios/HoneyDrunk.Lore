...
#
[
](https://huggingface.co#designing-the-hf-cli-as-an-agent-optimized-way-to-work-with-the-hub)
Designing the hf CLI as an agent-optimized way to work with the Hub
...
##
[
](https://huggingface.co#ai-agent-traffic-on-the-hub)
...
##
[
](https://huggingface.co#built-for-humans-and-agents)
...
###
[
](https://huggingface.co#one-command-multiple-renderings)
...
###
[
](https://huggingface.co#next-command-hints)
Next-command hints
...
###
[
](https://huggingface.co#non-blocking-and-safe-to-retry)
...
###
[
](https://huggingface.co#discoverable-predictable-commands)
...
##
[
](https://huggingface.co#benchmarking-the-hf-cli-for-coding-agents)
...
###
[
](https://huggingface.co#the-setup)
The setup
...
CLI in two configurations, with and without its skill (a generated command reference we come back to in [its own section](https://huggingface.co#the-hf-cli-skill)). But the headline comparison below is simply ** hf CLI vs curl / the SDK**; the skill's incremental effect is small enough that we break it out on its own rather than crowd it into the main results.
...
##
[
](https://huggingface.co#the-hf-cli-skill)
The hf-cli skill
...
##
[
](https://huggingface.co#register-an-agent-harness)
