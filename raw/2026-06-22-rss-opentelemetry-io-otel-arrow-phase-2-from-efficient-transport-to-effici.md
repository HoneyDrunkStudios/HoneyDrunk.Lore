---
source: "https://opentelemetry.io/blog/2026/otel-arrow-phase-2"
...
source_type: "rss"
discovered_via: "https://opentelemetry.io/blog/index.xml"
---
...
By **[Laurent Querel](https://github.com/lquerel) (F5, project lead), [Joshua MacDonald](https://github.com/jmacd) (Microsoft, project lead), [Reiley Yang](mailto:reyang@microsoft.com) (Microsoft, project sponsor), [Albert Lockett](https://github.com/albertlockett) (F5), [Cijo Thomas](https://github.com/cijothomas) (Microsoft), [Drew Relmas](https://github.com/drewrelmas) (Microsoft), [Jake Dern](https://github.com/JakeDern) (F5)** |
Friday, June 12, 2026
...
[OTLP](/docs/specs/otlp/) (OpenTelemetry Protocol) through a separate
first-class data path.
...
![Three benchmark summaries showing low incremental CPU cost for OTAP transformations as rename rules increase, lower CPU usage with larger batches, and bounded memory under overload](/blog/2026/otel-arrow-phase-2/3-takeaways.svg)
...
![Chart comparing measured Dataflow Engine speedup with ideal linear scaling from 1 to 16 cores for OTLP ingestion, reaching 14.6x on 16 cores](/blog/2026/otel-arrow-phase-2/otlp-scaling.svg)
...
![Chart comparing OTAP and OTLP throughput on the Dataflow Engine across core counts, with the OTAP path delivering roughly 10 to 20 times the throughput](/blog/2026/otel-arrow-phase-2/otap-scaling.svg)
...
- [←Previous](/blog/2026/otel-graduates/)
- Next→

Last modified June 12, 2026: [Blog - OTel-Arrow Phase 2: From Efficient Transport to Efficient Telemetry Pipelines (#10212) (ab725471)](https://github.com/open-telemetry/opentelemetry.io/commit/ab725471f2b3eab8eef931273b18cb45c6889c34)
